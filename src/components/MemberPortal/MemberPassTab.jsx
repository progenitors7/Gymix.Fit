  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        ...
        {/* Quick Info & Stats (Takes 1 column on desktop) */}
        <div className="flex flex-col gap-6 justify-between lg:col-span-1">
          
          {/* Workout Streak Widget */}
          <div 
            onClick={() => setActiveTab('streaks')}
            className="bg-[#1A1F2B] border border-white/5 p-6 rounded-[2rem] text-center space-y-2 relative group overflow-hidden transition-all duration-200 hover:border-orange-500/30 hover:bg-orange-500/[0.02] cursor-pointer flex-1 flex flex-col justify-center"
          >
            <Flame className="w-7 h-7 text-orange-500 mx-auto mb-1" />
          ...
          <div className="bg-[#1A1F2B] border border-white/5 p-6 rounded-[2rem] text-center space-y-2 relative group overflow-hidden transition-all duration-200 hover:border-emerald-500/30 hover:bg-emerald-500/[0.02] flex-1 flex flex-col justify-center">
            <Activity className="w-7 h-7 text-emerald-400 mx-auto mb-1" />
          ...
          <div 
            ...
            className="md:hidden p-4.5 rounded-[2rem] bg-[#1A1F2B] border border-[#3B82F6]/10 flex items-center justify-between cursor-pointer active:scale-98 transition-all duration-200"
          >
